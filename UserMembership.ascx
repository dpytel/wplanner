            ...
            <div class="epi-formArea">
                ...
                <div class="epi-size10">
                    <asp:Panel runat="server">
                        ...
                        <asp:TextBox Width="300" runat="server" ID="UserName" MaxLength="256" />
                        ...
                        <asp:RegularExpressionValidator runat="server" Text="*" ErrorMessage="<%$ Resources: EPiServer, admin.edituser.charsnotallowed %>" ID="UserNameValidator" ControlToValidate="UserName" Display="Dynamic" EnableClientScript="false"/>
                    </asp:Panel>
                    
                    <asp:Panel runat="server">
                        <asp:Label runat="server" AssociatedControlID="Password" Text="<%$ Resources: EPiServer, admin.secedit.editpassword %>"></asp:Label>
                        <asp:TextBox runat="server" ID="Password" MaxLength="128" Width="300" TextMode="Password" />
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PasswordConfirmPanelRow" runat="server">
                        ...
                        <asp:TextBox runat="server" ID="PasswordConfirm" MaxLength="128" Width="300" TextMode="Password" />
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PasswordAnswerPanelRow" runat="server">
                        <asp:Label runat="server" AssociatedControlID="PasswordAnswer" Text="<%$ Resources: EPiServer, admin.secedit.passwordquestion %>"></asp:Label>
...
<asp:PlaceHolder ID="ToolbarPanel" runat="server">
    <div class="epi-buttonContainer">
        <EPiServerUI:ToolButton id="ApplyButton" onclick="SaveButton_Click" skinid="Save" text="<%$ Resources: EPiServer, button.save %>" tooltip="<%$ Resources: EPiServer, button.save %>" runat="server" /><EPiServerUI:ToolButton id="DeleteButton" OnClientClick='<%#"OpenDeleteDialog(\"" + Server.UrlEncode(MembershipUser.Value) + "\", 0)"%>' GeneratesPostback="false" skinid="Delete" visible="<%# IsAdminMode %>" text="<%$ Resources: EPiServer, button.delete %>" tooltip="<%$ Resources: EPiServer, button.delete %>" runat="server" />
    </div>
</asp:PlaceHolder>
...
<script type="text/javascript">
    ...
    function OpenDeleteDialog(roleName, securityEntityType) {
        OpenDialogMembershipDeleteUserOrRole(roleName, securityEntityType, MembershipDeleteCompleted, null, null);
    }
...
<script runat="server">
    ...
    {
        base.OnLoad(e);
        if (!IsAdminMode && !MembershipUser.Value.Equals(EPiServer.Security.PrincipalInfo.Current.Name, System.StringComparison.OrdinalIgnoreCase))
        {
            ((EPiServer.PageBase)this.Page).AccessDenied();
        }
    }
</script>